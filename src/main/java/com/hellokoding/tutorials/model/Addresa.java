...
public class Addresa implements Serializable{
    public Addresa(String judet, String oras, String strada,TimpLivrare timpLivrare) {
        super();
        this.judet = judet;
        this.oras = oras;
        this.Strada = strada;
    ...
    public TimpLivrare getTimpLivrare() {
        return timpLivrare;
    }

    public void setTimpLivrare(TimpLivrare timpLivrare) {
        this.timpLivrare = timpLivrare;
    }
