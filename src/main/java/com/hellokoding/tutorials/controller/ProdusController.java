...
public class ProdusController {
    ...
    private final ProdusRepository cos;
    private final CartItemRepository cartItemRepository;
    private final UserRepository userRepository;

    public ProdusController(ProdusRepository produsRepository, ProdusRepository cos, CartItemRepository cartItemRepository, UserRepository userRepository) {
